...
[I reverse-engineered the OP-1 drum patch](https://schollz.com/blog/op1/) so you can build your own drum patches from the OP-1. This repo is a server that you can chop up sounds from the internet for easy loading into the OP-1. For more info about it, check out [my blog post](https://schollz.com/blog/op1/). The server is currently hosted here: https://op1.schollz.com
